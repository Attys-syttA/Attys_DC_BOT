...
A Dockerfile jelenlegi `CMD` parancsa a hosszan futo `npm run nas:control-plane`. Ez periodikus public-safe statuszt ir a kontener logba. Nem indit Discord botot es nem futtat Codexet a NAS-on.

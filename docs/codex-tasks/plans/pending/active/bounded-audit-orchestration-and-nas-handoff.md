...
- NAS handoff gate: `/nas handoff-gate` read-only, fail-closed előfeltétel-riportot ad. A NAS architecture handoff `blocked`, amíg source publication, security review, shared-vs-NAS scope split, NAS repo plan és explicit remote-boundary approval nincs lezárva.
...
- **részben kész:** read-only `/nas handoff-gate` parancs készült a fenti előfeltételek public-safe láthatóságára. A gate alapból `blocked`, és nem ír NAS repo source-t, nem indít remote executiont, nem deployol.

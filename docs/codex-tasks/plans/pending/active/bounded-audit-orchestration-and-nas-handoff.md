...
- **részben kész:** ugyanaz a check catalog izolált repair worktree-ben újrafuttatható `/audit recheck` paranccsal, és `/audit status` már review-ready public-safe változásszámokat is mutat; tényleges Codex repair turn továbbra sincs.

...
export const HELP_ENTRIES: HelpEntry[] = [
  ...
  },
  {
    name: "nas",
    category: "ops",
    usage: "/nas status | /nas doctor | /nas worker-status | /nas worker-deploy-verify | /nas handoff-gate | /nas deploy-status | /nas deploy-plan | /nas deploy-apply | /nas rollback-plan commit:<optional> | /nas container-status | /nas request check:<plans|lint|typecheck|tests|build|full> | /nas requests status:<all|queued|completed|failed> limit:<1-10> | /nas request-status request:<id-prefix> | /nas mailbox box:<inbox|outbox|archive> limit:<1-10> | /nas mailbox-status | /nas results limit:<1-10> | /nas bridge action:<status|start|stop|restart> | /nas smoke | /nas sync-status",

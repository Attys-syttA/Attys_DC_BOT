...
- `/nas handoff-gate` is read-only and fail-closed. It shows which NAS architecture handoff prerequisites are already locally supported and which human/architecture checkpoints still block NAS repo source writes or remote execution changes.
